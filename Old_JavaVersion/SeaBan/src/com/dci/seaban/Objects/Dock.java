...
public class Dock extends SceneObject{

	public int gameX = 0;
	public int gameY = 0;

	public Dock(Context context, String fileName, String shaderName, SceneRender render, int textureResID, int texture2ResID, int texture3ResID) {
